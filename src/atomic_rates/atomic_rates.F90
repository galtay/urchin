...
contains
  ...
  subroutine read_atomic_rates_file(table, AtomicRatesFile)
    ...
    write(str,'(A,A)') 'using rates file: ', trim(AtomicRatesFile)
...
!    logical, parameter :: crash = .true.
    ...
    write(loglun,101) "HII Rec Cool (A)", k%HIIrccA, " erg cm^3/s"
    write(loglun,101) "HII Rec Cool (B)", k%HIIrccB, " erg cm^3/s"
    write(loglun,*) 
    write(loglun,101) "HeII Rec Cool (A)", k%HeIIrccA,  " erg cm^3/s"
    write(loglun,101) "HeII Rec Cool (B)", k%HeIIrccB,  " erg cm^3/s"
    write(loglun,*) 
    write(loglun,101) "HeIII Rec Cool (A)", k%HeIIIrccA, " erg cm^3/s"
    write(loglun,101) "HeIII Rec Cool (B)", k%HeIIIrccB, " erg cm^3/s"
    write(loglun,*) 
    write(loglun,101) "He D Rec Cool", k%HeDrcc, " erg cm^3/s"
    write(loglun,*) 

    write(loglun,101) "HI Col Ion Cool", k%HIcic, " erg cm^3/s"
    write(loglun,101) "HeI Col Ion Cool", k%HeIcic, " erg cm^3/s"
    write(loglun,101) "HeII Col Ion Cool", k%HeIIcic, " erg cm^3/s"
    write(loglun,101) "He 23 Col Ion Cool", k%He23cic, " erg cm^3/s"
    write(loglun,*) 


    write(loglun,101) "HI Col Ext Cool", k%HIcec, " erg cm^3/s"
    write(loglun,101) "HeI Col Ext Cool", k%HeIcec, " erg cm^6/s"
    write(loglun,101) "HeII Col Ext Cool", k%HeIIcec, " erg cm^3/s"
