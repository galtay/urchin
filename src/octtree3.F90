...
use particle_system_mod, only: make_output_list
implicit none
...
!-----------------------------------------------------------------------------
 subroutine buildtree(psys, tree, MBalloc, ppc)
   ...
   type(particle_system_type), intent(inout) :: psys !< input particle system
