...
subroutine get_planning_data_gadget_cosmoBH()
  ...
  integer(i4b) :: iSnap           ! snapshot number
  ...
  do j = 0,pfiles-1
     ...
     call form_gadget_snapshot_file_name(CV%SnapPath, CV%ParFileBase, j, snapfile, hdf5bool=.false.)
     ...
     saved_gheads(j)%time_gyr = time_Gyr
